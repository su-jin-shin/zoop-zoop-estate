...
// 검색 데이터를 카테고리별로 분리 (SearchFilters와 동일)
const locationData = {
  regions: [
        ...
        <div className="relative" ref={dropdownRef}>
          <div className="bg-white rounded-full border border-gray-200 py-1 px-2 flex items-center">
            ...
            <Input 
              ...
              className="border-0 focus-visible:ring-0 flex-grow text-xs sm:text-sm h-7 sm:h-8 px-2"
              value={searchQuery}
            ...
            />
            <Button size="sm" className="rounded-full h-6 w-6 sm:h-7 sm:w-7 p-0 bg-real-blue hover:bg-real-blue/90">
